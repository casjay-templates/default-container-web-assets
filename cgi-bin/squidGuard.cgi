...
# German texts thanks to Buergernetz Pfaffenhofen (//www.bn-paf.de/filter/)
...
$redirect    = "//admin.your-domain/images/blocked.gif";		# "" TO AVOID REDIRECTION
...
my $squidguard = "//www.squidguard.org";
my $squidguardlogo = "//www.squidguard.org/Logos/squidGuard.gif";
...
sub showinaddr($$$$$) {
  ...
  if (@names) {
    ...
    print "<!DOCTYPE html PUBLIC \"-//W3C//DTD  HTML 4.0 Transitional//EN\" \"//www.w3.org/TR/REC-html40/loose.dtd\">\n";
    print "<html><head>\n";
