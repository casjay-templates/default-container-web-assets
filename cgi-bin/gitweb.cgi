...
#our $logo_url = "//www.kernel.org/pub/software/scm/git/docs/";
#our $logo_label = "git documentation";
our $logo_url = "//scm.casjay.org/";
...
sub href {
  ...
  if ($use_pathinfo and defined $params{'project'}) {
    ...
    # $href here would be something like //gitweb.example.com/
...
# //www.cs.indiana.edu/picons/search.html
sub picon_url {
  my $email = lc shift;
...
<a href="//en.wikipedia.org/wiki/Regular_expression">regular expression</a> (also case
insensitive).</p>
<dl>
<dt><b>commit</b></dt>
...
sub git_feed {
  ...
  # RSS:  //www.notestips.com/80256B3A007F2692/1/NAMO5P9UPQ
