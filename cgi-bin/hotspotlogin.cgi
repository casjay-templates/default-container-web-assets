...
<WISPAccessGatewayParam 
  ...
  xsi:noNamespaceSchemaLocation=\"//www.acmewisp.com/WISPAccessGatewayParam.xsd\">
<AuthenticationReply>
...
<head>
  ...
  <meta http-equiv=\"Pragma\" content=\"no-cache\">";
	...
	print "  <meta http-equiv=\"refresh\" content=\"0;url=//$uamip:$uamport/logon?username=$username&password=$pappassword&userurl=$userurl\">";
    } else {
	print "  <meta http-equiv=\"refresh\" content=\"0;url=//$uamip:$uamport/logon?username=$username&response=$response&userurl=$userurl\">";
    }
print "</head>
<body bgColor = '#c0d8f4'>";
...
";
    if ((defined $uamsecret) && defined($userpassword)) {
	print "<LoginResultsURL>//$uamip:$uamport/logon?username=$username&password=$pappassword</LoginResultsURL>";
    } else {
	print "<LoginResultsURL>//$uamip:$uamport/logon?username=$username&response=$response&userurl=$userurl</LoginResultsURL>";
    }
...
if ($result == 1) {
  ...
  print "
  <center>
    <a href=\"//$uamip:$uamport/logoff\">Logout</a>
  </center>
</body>
</html>";
}
...
if (($result == 3) || ($result == 13)) {
  ...
  <center>
    <a href=\"//$uamip:$uamport/prelogin\">Login</a>
  </center>
</body>
</html>";
}
